...
const ProfileSide = ({ name, description, picture }) => {
  ...
  return (
    <div className="w-[35ch] min-h-100 p-5 flex flex-col items-stretch gap-5 border-2 border-border rounded-xl bg-zinc-950">
      <div className="flex flex-col gap-2 items-center">
        <Avatar
          className="relative cursor-pointer min-h-40 w-auto"
